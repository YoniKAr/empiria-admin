        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5 space-y-4">
          ...
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/40 focus:border-indigo-500"
                disabled={sending}
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/40 focus:border-indigo-500 resize-none"
                disabled={sending}
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 justify-end">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-1.5 text-sm font-medium text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
